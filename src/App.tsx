            ...
            >
              ...
              <div className="flex items-center gap-3">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-5 py-2.5 bg-surface-container-lowest border border-outline-variant rounded-full text-sm font-medium hover:bg-surface-container-low transition-colors"
                >
